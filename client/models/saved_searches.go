...
// FlexBool unmarshals JSON values that Splunk returns as either a
// string-encoded boolean ("0", "1", "false", "true"), a bare integer
// (0, 1), or a boolean (false, true).
type FlexBool bool
...
func (f *FlexBool) UnmarshalJSON(data []byte) error {
	...
	case float64:
		...
		case 1:
			*f = true
		default:
			return fmt.Errorf("cannot parse %v as bool", v)
		}
	case string:
	...
	default:
		return fmt.Errorf("cannot unmarshal %T into FlexBool", raw)
	}
...
type SavedSearchObject struct {
	...
	ActionHttpalertParamVerifySslCertificate           FlexBool `json:"action.httpalert.param.verify_ssl_certificate" url:"action.httpalert.param.verify_ssl_certificate"`
